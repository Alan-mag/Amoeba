...
{
	m_VertexArray = Amoeba::VertexArray::Create();
	...
	Amoeba::Ref<Amoeba::VertexBuffer> vertexBuffer = Amoeba::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Amoeba::Ref<Amoeba::IndexBuffer> indexBuffer = Amoeba::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	Amoeba::Ref<Amoeba::VertexBuffer> squareVB = Amoeba::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Amoeba::ShaderDataType::Float3, "a_Position" },
	...
	Amoeba::Ref<Amoeba::IndexBuffer> squareIB = Amoeba::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Amoeba::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(Amoeba::Event& e)
{
