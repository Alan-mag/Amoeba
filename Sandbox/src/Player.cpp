...
Player::Player()
{
	...
	m_SmokeParticle.ColorBegin = { 0.9f, 0.9f, 0.9f, 1.0f };
	// m_SmokeParticle.ColorEnd = { 0.6f, 0.6f, 0.6f, 1.0f };
	m_SmokeParticle.ColorEnd = { 0.7f, 0.7f, 0.7f, 1.0f };
	...
	m_EngineParticle.ColorBegin = { 254 / 255.0f, 10 / 255.0f, 41 / 255.0f, 1.0f };
	// m_EngineParticle.ColorEnd = { 254 / 255.0f, 212 / 255.0f, 123 / 255.0f , 1.0f };
	m_EngineParticle.ColorEnd = { 254 / 255.0f, 21 / 255.0f, 12 / 255.0f , 1.0f };
...
void Player::OnUpdate(Amoeba::Timestep ts)
{
	...
	if (Input::IsKeyPressed(AMOEBA_KEY_SPACE))
	{
