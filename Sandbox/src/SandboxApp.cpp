...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		std::shared_ptr<Amoeba::VertexBuffer> vertexBuffer;
		...
		std::shared_ptr<Amoeba::IndexBuffer> indexBuffer;
		...
		std::shared_ptr<Amoeba::VertexBuffer> squareVB;
		...
		std::shared_ptr<Amoeba::IndexBuffer> squareIB;
		...
		m_Shader.reset(new Amoeba::Shader(vertexSrc, fragmentSrc));
		...
		m_BlueShader.reset(new Amoeba::Shader(blueShaderVertexSrc, blueShaderFragmentSrc));
	}
	...
	void OnUpdate(Amoeba::Timestep ts) override
	{
		...
		Amoeba::Renderer::Submit(m_BlueShader, m_SquareVA);
...
private:
	std::shared_ptr<Amoeba::Shader> m_Shader;
	std::shared_ptr<Amoeba::VertexArray> m_VertexArray;

	std::shared_ptr<Amoeba::Shader> m_BlueShader;
	std::shared_ptr<Amoeba::VertexArray> m_SquareVA;
